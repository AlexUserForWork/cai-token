   ...
   return (
      <div id='about' className='relative'>
               ...
               <div className='w-1/2 full flex flex-col justify-center py-10 lg:px-20'>
                  ...
                  >
                     ...
                     <p className='text-[20px] mb-10 '>
                        Ready to ride the CAI rocket? Zero <br /> taxes and
                        Infinite FUN! 100% trust with <br /> the liquidity pool
                        BURNT to a crisp! <br /> HODL tight or FOMO later, cause
                        this <br /> meme is taking off! Swap your SOL for <br />{' '}
                        $CAI and join the moon mission!
                     </p>
         ...
         <div className='flex flex-col items-center md:hidden relative'>
            <img src={Title2} className='w-[40%] h-[100px] absolute' alt='' />
            <img
               src={Title1}
            ...
            <div className='flex flex-col font-luckiest '>
               <p className='text-[14px] mb-5 px-5'>
                  Ready to ride the CAI rocket? Zero taxes and Infinite FUN!
                  100% trust with the liquidity pool BURNT to a crisp! HODL
                  tight or FOMO later, cause this meme is taking off! Swap your
                  SOL for $CAI and join the moon mission!
               </p>
